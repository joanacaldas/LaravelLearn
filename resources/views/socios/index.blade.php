...
<div class="container-fluid p-5" style="background-color: #d9c09e;">
        ...
        <div class="col-md-8">
            <div class="card shadow-lg" style="background-color: #fff;">
                <div class="card-header text-center" style="background-color: #add8e6; font-size: 2rem; font-weight: bold;">
                    Listagem de todos os sócios <a href="{{route('socio.create')}}" class="btn btn-outline-secondary" style="float:right"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-skip-backward-btn-fill" viewBox="0 0 16 16">
                        ...
                        <div class="card-header" style="background-color: #add8e6;"> Sócios registados: {{ $socios->total() }}
</div>
  ...
  <tr>
                                <p>
                                <td colspan="4" style="text-align: center; width: 100%;" >{{$socios->links()}}</td>
                                </p>
                            </tr>
    <tr>
  ...
  <tbody>
    ...
    <tr>
      ...
      @if ($socio->user->level == 'admin')

      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class=class="btn btn-outline-secondary" viewBox="0 0 16 16">
