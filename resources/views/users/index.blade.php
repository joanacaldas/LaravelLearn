                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> <a href="{{route('user.edit',$user->id)}}" class="btn btn-outline-primary"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
                                ...
                                <td> <a href="{{route('user.delete', $user->id)}}" class="btn btn-outline-danger">
